...
const Landing: React.FC<LandingProps> = ({ onGenerate, error }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      />
      <header className="w-full px-8 py-8 flex justify-between items-center fixed top-0 left-0 z-10" role="banner">
        ...
        <div className="w-full max-w-2xl text-center space-y-12">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl font-display tracking-wide text-off-white leading-tight">
              The missing piece in<br/>your DIY journey
            </h1>
          ...
          <section className="relative group max-w-xl mx-auto w-full" aria-labelledby="url-form-heading">
            <h2 id="url-form-heading" className="sr-only">Generate Instructions</h2>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4" aria-label="Project URL form">
      ...
      <footer className="w-full px-8 py-8 flex flex-col md:flex-row justify-between items-center border-t border-stone-light/5 bg-charcoal-bg/95 backdrop-blur-sm z-10" role="contentinfo">
        ...
        <div className="flex gap-8 items-center">
          ...
          <div className="flex gap-6">
            <a className="text-[10px] uppercase tracking-widest text-stone-light/40 hover:text-clay transition-colors" href="https://github.com/vynride/NanoCraft" target="_blank" rel="noopener noreferrer">Documentation</a>
            <Link to="/terms" className="text-[10px] uppercase tracking-widest text-stone-light/40 hover:text-clay transition-colors">Terms</Link>
          </div>
        </div>
      </footer>
    </div>
