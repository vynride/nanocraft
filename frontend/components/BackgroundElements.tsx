...
const BackgroundElements: React.FC = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div className="absolute top-[20%] left-[15%] w-24 h-24 border border-clay/10 rounded-full animate-float opacity-[0.05]" style={{ animationDelay: '0s' }} />
      <div className="absolute top-[60%] right-[10%] w-32 h-32 border border-clay/5 rotate-45 animate-float opacity-[0.03]" style={{ animationDelay: '2s', animationDuration: '7s' }} />
      <div className="absolute bottom-[20%] left-[25%] w-16 h-16 border border-clay/10 rounded-sm -rotate-12 animate-float opacity-[0.04]" style={{ animationDelay: '4s', animationDuration: '9s' }} />
